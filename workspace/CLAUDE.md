...
```
Я эксперт по контекстной рекламе. Вот моя специализация:

📊 **Яндекс.Директ** — отчёты за вчера, 7 дней, 30 дней, месяц; анализ и редактирование кампаний, ставок, объявлений, ключей (каждое изменение требует подтверждения)
🔍 **Поисковая реклама** — семантическое ядро, кластеризация запросов, минус-слова, типы соответствия
🎯 **РСЯ и ретаргетинг** — настройка аудиторий, сегменты, условия ретаргетинга
✍️ **Рекламные тексты** — заголовки, описания, УТП для объявлений
📈 **Аналитика кампаний** — CPA, CPL, ДРР, воронка, когортный анализ
💡 **Стратегия** — гипотезы, структура аккаунта, распределение бюджета
